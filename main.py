...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        top.title('Wpisz hasło')
        top.geometry('{}x{}'.format(250, 100))
        top.resizable(width=False, height=False)
        self.l = Label(top, text=" Hasło: ", font=('Courier', 14), justify=CENTER)
        self.l.pack()
        self.e = Entry(top, show='*', width=30)
        self.e.pack(pady=7)
        self.b = Button(top, text='Zaloguj', command=self.cleanup, font=('Courier', 14))
        self.b.pack()
    ...
    def cleanup(self):
        ...
        if self.value == access:
            ...
            if self.attempts == 5:
                window.quit()
            self.e .delete(0, 'end')
            messagebox.showerror('Złe hasło', 'Złe hasło, pozostałe próby: ' + str(5 - self.attempts))
...
class entity_display:
    ...
    def delete(self):
        answer = tkinter.messagebox.askquestion('Usuń', 'Jesteś pewny że chcesz usunąć?')
...
def onsubmit():
    ...
    messagebox.showinfo('Dodaj passy', 'Pomyślnie dodane')
    readfile()
...
entity_label = Label(window, text='Dodaj passy', font=('Courier', 18))
name_label = Label(window, text='Nazwa gry lub strony: ', font=('Courier', 14))
email_label = Label(window, text='Email/Login: ', font=('Courier', 14))
pass_label = Label(window, text='Hasło: ', font=('Courier', 14))
name = Entry(window, font=('Courier', 14))
email = Entry(window, font=('Courier', 14))
password = Entry(window, show='*', font=('Courier', 14))
submit = Button(window, text='Dodaj', command=onsubmit, font=('Courier', 14))
...
name_label2 = Label(window, text='Nazwa gry lub strony: ', font=('Courier', 14))
email_label2 = Label(window, text='Email/Login: ', font=('Courier', 14))
pass_label2 = Label(window, text='Hasło: ', font=('Courier', 14))
